...
import { get_listing_source_html, extract_events, get_event_source_html, extract_event_details } from "../helpers/international_conference_alert_helpers.js";
...
const get_events = async (req, res) => {
    ...
    const base_url = `https://internationalconferencealerts.com/searchfresult?country=USA&topic=&subtopic=&month=${month}`;
...
const get_event_by_id = async (req, res) => {
    ...
    const base_url = `https://internationalconferencealerts.com/eventdetails.php?id=${event_id}`
